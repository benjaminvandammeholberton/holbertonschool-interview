 ...
 *
 * @param grid The 3x3 grid representing the sandpile.
 *
 ...
 *
 * @param grid1 The first 3x3 grid representing a sandpile.
 * @param grid2 The second 3x3 grid representing another sandpile.
 */
